<?php
	...
	$data = implode(",",$dataKeys).PHP_EOL; //first row of csv, put commas between every csv header value and add newline at the end
	...
	for ($trialNum=0; $trialNum < $totalTrials; $trialNum++){ //number of rows
		...
		$row = $row . PHP_EOL; //add newline at the end of the row
